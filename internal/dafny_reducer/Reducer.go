...
func (_ CompanionStruct_Phase_) AllSingletonConstructors() _dafny.Iterator {
  ...
  return func() (interface{}, bool) {
    i++
    switch i {
      case 0: return Companion_Phase_.Create_Active_(), true
      case 1: return Companion_Phase_.Create_Recovering_(), true
      case 2: return Companion_Phase_.Create_Concluded_(), true
      default: return Phase{}, false
    }
  }
}
...
func (_this Command) Dtor_attemptID() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Command_CommandProposeRecovery: return data.AttemptID
    case Command_CommandConclude: return data.AttemptID
    default: return data.(Command_CommandUnknown).AttemptID
  }
}
...
func (_this Event) Dtor_attemptID() _dafny.Sequence {
  switch data := _this.Get_().(type) {
    case Event_EventRecoveryDispatched: return data.AttemptID
    case Event_EventRecoveryRejected: return data.AttemptID
    default: return data.(Event_EventConcluded).AttemptID
  }
}
...
func (_ CompanionStruct_DecisionStatus_) AllSingletonConstructors() _dafny.Iterator {
  ...
  return func() (interface{}, bool) {
    i++
    switch i {
      case 0: return Companion_DecisionStatus_.Create_Accepted_(), true
      case 1: return Companion_DecisionStatus_.Create_Rejected_(), true
      case 2: return Companion_DecisionStatus_.Create_NoOp_(), true
      default: return DecisionStatus{}, false
    }
  }
}
