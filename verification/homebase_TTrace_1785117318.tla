---- MODULE homebase_TTrace_1785117318 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("homebase_TTrace_1785117318.json", _TETrace)


_view ==
    <<state, recoveryAttempts, failed, IF TLCGet("level") = _TTraceLassoEnd + 1 THEN _TTraceLassoStart ELSE TLCGet("level")>>
=============================================================================
...
\*
\*trace == IODeserialize("homebase_TTrace_1785117318.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG homebase_TTrace_1785117318 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Sun Jul 26 18:55:18 PDT 2026