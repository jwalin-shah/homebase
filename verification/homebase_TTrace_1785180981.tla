---- MODULE homebase_TTrace_1785180981 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("homebase_TTrace_1785180981.json", _TETrace)
...
\*
\*trace == IODeserialize("homebase_TTrace_1785180981.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([recoveryAttempts |-> 0,state |-> "RECOVER",failed |-> TRUE,remainingDecisions |-> 3,recoveryLog |-> <<>>]),
    ([recoveryAttempts |-> 1,state |-> "RECOVER",failed |-> TRUE,remainingDecisions |-> 3,recoveryLog |-> <<1>>]),
    ([recoveryAttempts |-> 2,state |-> "EXECUTE",failed |-> FALSE,remainingDecisions |-> 3,recoveryLog |-> <<1, 2>>]),
    ([recoveryAttempts |-> 2,state |-> "RECOVER",failed |-> TRUE,remainingDecisions |-> 3,recoveryLog |-> <<1, 2>>])
    >>
----
...
---- CONFIG homebase_TTrace_1785180981 ----
CONSTANTS
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Jul 27 12:36:21 PDT 2026